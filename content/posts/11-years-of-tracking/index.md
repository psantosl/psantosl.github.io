...
{{< figure src="./diaryview.png" caption="The diary view — each day reads like a journal, which is what I always wanted from my spreadsheet" >}}

{{< figure src="./yearinreview.png" caption="Year in review — the kind of breakdown I used to wrestle out of pivot tables" >}}
